...
class AsmaAlHusnaDetailPage extends StatelessWidget {
  final RxInt nameNumber;
  final AsmaAlHusnaController controller = Get.find<AsmaAlHusnaController>();

  AsmaAlHusnaDetailPage({Key? key, required int initialNameNumber}) 
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      final name = controller.getNameByNumber(nameNumber.value);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Information text
              Text(
                "This is one of the 99 beautiful names of Allah mentioned in Islamic tradition. It represents the divine attribute of ${name['en']['meaning']}.",
                style: TextStyle(
                  fontSize: 14,
                  color: kTextPrimary,
                  height: 1.5,
              ...
              // Understanding text
              Text(
                "Understanding and reflecting on this name helps believers develop a deeper connection with Allah and appreciate the completeness of His attributes.",
                style: TextStyle(
                  fontSize: 14,
                  color: kTextPrimary,
                  height: 1.5,
