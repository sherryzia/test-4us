// lib/views/screens/home_content.dart - Updated with Dynamic Currency
...
class HomeContent extends StatelessWidget {
            ...
            child: SingleChildScrollView(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    // Circular Progress Chart with Dynamic Currency
                    Obx(() => Center(
                      child: Container(
                        width: 280,
                        height: 280,
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Obx(() => MyText(
                                  text: globalController.formatCurrency(controller.availableBalance.value),
                                  size: 28,
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Obx(() => MyText(
                                      text: 'Income: ${globalController.formatCurrency(controller.totalIncome.value)}',
                                      size: 12,
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(width: 4),
                                    Obx(() => MyText(
                                      text: 'Spent: ${globalController.formatCurrency(controller.spentAmount.value)}',
                                      size: 12,
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                MyText(
                                  text: 'Current Currency: ${globalController.currentCurrency.value}',
                                  size: 14,
                                  weight: FontWeight.w600,
                                  color: kwhite,
                                ),
                                MyText(
                                  text: 'Change currency in Profile to convert all amounts',
                                  size: 12,
                                  color: kwhite.withOpacity(0.7),
                                ),
                              ],
                    ...
                    // Transactions List (Income + Expenses) with Dynamic Currency
                    Obx(() => Column(
                      children: controller.expenses.map((transaction) => 
                        _buildTransactionItem(transaction, globalController)
                      ).toList(),
                    )),
  ...
  Widget _buildTransactionItem(ExpenseItem transaction, GlobalController globalController) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          MyText(
            text: '${isIncome ? '+' : ''}${globalController.formatCurrency(transaction.amount.abs())}',
            size: 16,
            weight: FontWeight.bold,
