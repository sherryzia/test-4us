...
class StatisticsScreen extends StatelessWidget {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Spending Summary Card with proper currency conversion
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 20.0),
              child: _buildSpendingSummaryCard(homeController, statisticsController, globalController),
            ),
            ...
            // Transaction List with converted amounts
            _buildRecentTransactions(homeController, globalController),
  ...
  // Spending summary card with proper currency conversion
  Widget _buildSpendingSummaryCard(HomeController homeController, StatisticsController statisticsController, GlobalController globalController) {
      ...
      builder: (homeController) => Container(
        ...
        child: Column(
          children: [
            ...
            // Summary stats with proper currency conversion
            Row(
              children: [
                // Total Spent
                Expanded(
                  child: _buildSummaryItem(
                    title: 'Total Spent',
                    amount: globalController.formatCurrency(homeController.spentAmount.value),
                ...
                Expanded(
                  child: _buildSummaryItem(
                    title: 'Daily Average',
                    amount: globalController.formatCurrency(homeController.spentAmount.value / 30),
            ...
            Row(
              children: [
                ...
                Expanded(
                  child: _buildSummaryItem(
                    title: 'Remaining',
                    amount: globalController.formatCurrency(homeController.availableBalance.value),
  ...
  // Recent transactions with proper currency conversion
  Widget _buildRecentTransactions(HomeController controller, GlobalController globalController) {
    return GetX<HomeController>(
      builder: (controller) => Column(
        children: controller.expenses
          .take(3)
          .map((expense) => _buildTransactionItem(expense, globalController))
          .toList(),
      ),
    );
  }
  
  Widget _buildTransactionItem(ExpenseItem expense, GlobalController globalController) {
    return Container(
      ...
      child: Row(
        children: [
          ...
          // Amount with proper currency conversion
          MyText(
            text: globalController.formatCurrency(expense.amount.abs()),
            size: 18,
            weight: FontWeight.bold,
            color: kwhite,
          ),
