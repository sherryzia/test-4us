...
import 'package:quran_app/view/AsmaUlNabi/AsmaUlNabiDetails.dart';

class AsmaUlNabiScreen extends StatelessWidget {
  final AsmaUlNabiController controller = Get.put(AsmaUlNabiController());

  AsmaUlNabiScreen({Key? key}) : super(key: key);
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            "Loading the Names of the Prophet...",
            style: TextStyle(
              ...
              children: [
                ...
                IconButton(
                  ...
                  onPressed: () {
                    ...
                    Get.to(() => AsmaUlNabiDetailPage(initialNameNumber: number));
                  },
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              Text(
                "The names of Prophet Muhammad (peace be upon him) reflect his noble character, mission, and significance in Islam.",
                style: TextStyle(
                  fontSize: 14,
                  color: kTextPrimary,
                  height: 1.5,
              ...
              const SizedBox(height: 12),
              Text(
                "Understanding and reflecting on these names helps us appreciate the Prophet's life and teachings.",
                style: TextStyle(
                  fontSize: 14,
                  color: kTextPrimary,
                  height: 1.5,
