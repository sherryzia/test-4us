...
class _LookingForState extends State<LookingFor> {
  ...
  void initState() {
    super.initState();
    // Set initial ideal match selection
    WidgetsBinding.instance.addPostFrameCallback((_) {
      profileController.setIdealMatchGenderByIndex(0); // Default to Male
    });
  }
  ...
  Widget build(BuildContext context) {
    final List<String> images = [
      Assets.imagesMale2Image,
      Assets.imagesFemale2Image,
      Assets.imagesLookingForNonBinary,
    ];
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          MyText(
                            text:
                                'Understanding your dating preferences is key to providing a great experience. Let us know who you\'d like to meet so we can introduce you to the right people.',
                            size: 16,
                            lineHeight: 1.5,
                      ...
                      child: PageView.builder(
                        ...
                        onPageChanged: (v) {
                          setState(() {
                            ...
                            profileController.setIdealMatchGenderByIndex(v);
                            print('Ideal match selected: ${gender[v]} -> ${profileController.idealMatchGender.value}');
                    ...
                    Obx(() => Padding(
                      ...
                      child: Text(
                        'Selected: ${profileController.idealMatchGender.value}',
