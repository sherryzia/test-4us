...
class ProviderTermsCondtionScreen extends StatefulWidget {
  const ProviderTermsCondtionScreen({super.key});

  @override
  State<ProviderTermsCondtionScreen> createState() => _ProviderTermsCondtionScreenState();
}

class _ProviderTermsCondtionScreenState extends State<ProviderTermsCondtionScreen> {
  @override
