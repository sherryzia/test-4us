...
class ProviderPrivacyScreen extends StatefulWidget {
  const ProviderPrivacyScreen({super.key});

  @override
  State<ProviderPrivacyScreen> createState() => _ProviderPrivacyScreenState();
}

class _ProviderPrivacyScreenState extends State<ProviderPrivacyScreen> {
  @override
