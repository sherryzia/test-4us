...
class ProviderAboutUsScreen extends StatefulWidget {
  const ProviderAboutUsScreen({super.key});

  @override
  State<ProviderAboutUsScreen> createState() => _ProviderAboutUsScreenState();
}

class _ProviderAboutUsScreenState extends State<ProviderAboutUsScreen> {
  @override
