...
import 'package:forus_app/view/event_organizer/event_settings/event_aboutus.dart';
import 'package:forus_app/view/event_organizer/event_settings/event_contactus.dart';
import 'package:forus_app/view/event_organizer/event_settings/event_edit_profile.dart';
import 'package:forus_app/view/event_organizer/event_settings/event_manage_business.dart';
import 'package:forus_app/view/event_organizer/event_settings/event_privacy.dart';
import 'package:forus_app/view/event_organizer/event_settings/event_secondary.dart';
import 'package:forus_app/view/event_organizer/event_settings/event_terms.dart';
import 'package:forus_app/view/event_organizer/event_settings/event_wallet.dart';
...
import 'package:forus_app/view/service_provider/provider_settings/provider_manage_business.dart';
...
class EventSettingMainScreen extends StatefulWidget {
  const EventSettingMainScreen({super.key});

  @override
  State<EventSettingMainScreen> createState() => _EventSettingMainScreenState();
}

class _EventSettingMainScreenState extends State<EventSettingMainScreen> {
  @override
            ...
            child: Column(
              children: [
                CustomContainer(
                    ...
                    text: 'Edit Profile',
                    onTap: () {
                      Get.to(() => EventEditProfileScreen());
                    }),
                CustomContainer(
                    img: Assets.imagesBriefcaseSettings,
                    text: 'Manage Business ',
                    onTap: () {
                      Get.to(() => EventManageBusinessScreen());
                    }),
                CustomContainer(
                    img: Assets.imagesWallet,
                    text: 'Wallet ',
                    onTap: () {
                      Get.to(() => EventWalletScreen());
                    }),
                CustomContainer(
                    img: Assets.imagesSetting,
                    text: 'Settings',
                    onTap: () {
                      Get.to(() => EventSettingSecondaryScreen());
                    }),
                CustomContainer(
                    img: Assets.imagesShieldSecurity,
                    text: 'Privacy Policy',
                    onTap: () {
                      Get.to(() => EventPrivacyScreen());
                    }),
                CustomContainer(
                    img: Assets.imagesTerms,
                    text: 'Terms & Conditions ',
                    onTap: () {
                      Get.to(() => EventTermsCondtionScreen());
                    }),
                CustomContainer(
                    img: Assets.imagesInfoCircle,
                    text: 'About Us ',
                    onTap: () {
                      Get.to(() => EventAboutUsScreen());
                    }),
                CustomContainer(
                    img: Assets.imagesContactus,
                    text: 'Contact Us',
                    onTap: () {
                      Get.to(() => EventContactUsScreen());
                    }),
                CustomContainer(
