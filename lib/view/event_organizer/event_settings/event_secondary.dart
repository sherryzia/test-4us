...
import 'package:forus_app/view/event_organizer/event_settings/event_otp.dart';
...
class EventSettingSecondaryScreen extends StatefulWidget {
  const EventSettingSecondaryScreen({super.key});

  @override
  State<EventSettingSecondaryScreen> createState() =>
      _EventSettingSecondaryScreenState();
}

class _EventSettingSecondaryScreenState
    extends State<EventSettingSecondaryScreen> {
