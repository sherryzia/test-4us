...
class EventPrivacyScreen extends StatefulWidget {
  const EventPrivacyScreen({super.key});

  @override
  State<EventPrivacyScreen> createState() => _EventPrivacyScreenState();
}

class _EventPrivacyScreenState extends State<EventPrivacyScreen> {
  @override
