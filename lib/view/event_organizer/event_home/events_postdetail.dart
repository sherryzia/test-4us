...
import 'package:forus_app/view/event_organizer/event_home/events_paid.dart';
...
class EventPostDetailScreen extends StatefulWidget {
  const EventPostDetailScreen({super.key});

  @override
  State<EventPostDetailScreen> createState() => _EventPostDetailScreenState();
}

class _EventPostDetailScreenState extends State<EventPostDetailScreen> {
  @override
                    ...
                    Row(
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            CommonImageView(
                              imagePath: Assets.imagesComment,
                              height: 20,
                            ),
                            MyText(
                              paddingLeft: 5,
